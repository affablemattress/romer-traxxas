#ifndef _ROS_imu_parser_IMURaw_h
#define _ROS_imu_parser_IMURaw_h
...
namespace imu_parser
{
  ...
  class IMURaw : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "imu_parser/IMURaw"; };
    virtual const char * getMD5() override { return "22eeef76ab4645786a2d92bcfbc4c574"; };
